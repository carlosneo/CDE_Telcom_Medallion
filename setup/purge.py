...
def main():
    ...
    for i in range(int(maxParticipants)):
        ...
        print("\nDROP TABLE NAVIGATION_BRONZE")
        dropTable(spark, "NAVIGATION_BRONZE")
        print("\nDROP TABLE PRODUCTS_SILVER")
        dropTable(spark, "PRODUCTS_SILVER")
        print("\nDROP TABLE FACTS_SILVER")
        dropTable(spark, "FACTS_SILVER")
        print("\nDROP TABLE PRODUCT_NAMES_GOLD")
        dropTable(spark, "PRODUCT_NAMES_GOLD")
        print("\nDROP TABLE COUNT_USERS_PER_PRODUCT_GOLD")
        dropTable(spark, "COUNT_USERS_PER_PRODUCT_GOLD")
        print("\nDROP TABLE AVG_VALUE_PER_PRODUCT_GOLD")
        dropTable(spark, "AVG_VALUE_PER_PRODUCT_GOLD")
        print("\nDROP TABLE MONITORING_KEY_FIELDS_GOLD")
        dropTable(spark, "MONITORING_KEY_FIELDS_GOLD")
