...
#### MONITORING
monitoringKeyFieldsGoldDf = spark.sql("SELECT IDATENDIMENTO, NU_TLFN, DT_PRMR_ATCV_LNHA, PRODUCTID, NRPROTOCOLO, INTERESSE, GROSSVALUE \
...
print("SCHEMA EVOL: EXECUTING ICEBERG TYPE CONVERSION ON IDATENDIMENTO MONITORING_KEY_FIELDS_GOLD TABLE:")
print("ALTER TABLE SPARK_CATALOG.TELCO_MEDALLION.MONITORING_KEY_FIELDS_GOLD ALTER COLUMN IDATENDIMENTO TYPE BIGINT")
spark.sql("ALTER TABLE SPARK_CATALOG.TELCO_MEDALLION.MONITORING_KEY_FIELDS_GOLD ALTER COLUMN IDATENDIMENTO TYPE BIGINT")
...
spark.sql("ALTER TABLE SPARK_CATALOG.TELCO_MEDALLION.MONITORING_KEY_FIELDS_GOLD DROP PARTITION FIELD MONTHS(dtprazofinalanatel)")

print("\nALTER TABLE SPARK_CATALOG.TELCO_MEDALLION.ATENDIMENTO_BRONZE ADD PARTITION FIELD DAYS(dtprazofinalanatel)")
spark.sql("ALTER TABLE SPARK_CATALOG.TELCO_MEDALLION.MONITORING_KEY_FIELDS_GOLD ADD PARTITION FIELD DAYS(dtprazofinalanatel)")
