...
class TelcoDataGen:
    ...
    def navigationDataGen(self, shuffle_partitions_requested = 200, partitions_requested = 2000, data_rows = 470000000):
    ...
    def atendimentoDataGen(self, shuffle_partitions_requested = 10, partitions_requested = 10, data_rows = 1500):
    ...
    def antennaDataGen(self, shuffle_partitions_requested = 200, partitions_requested = 500, data_rows = 13000000):
    ...
    def productSubscriptionDataGen(self, shuffle_partitions_requested = 10, partitions_requested = 10, data_rows = 2000):
    ...
    def svaSubscriptionDataGen(self, shuffle_partitions_requested = 10, partitions_requested = 10, data_rows = 1000):
